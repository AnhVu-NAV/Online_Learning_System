...
<!-- Truyền dữ liệu tĩnh vào để test -->
<c:set var="blog" value="${{ 
    'blogId': 1, 
    'title': 'Test Blog Title', 
    'authorName': 'Admin Huy', 
    'updatedDate': '2024-10-07', 
    'category': 'Technology', 
    'content': 'This is a test content for the blog. It describes various details about the post.'
}}" />

<!-- Truyền danh sách categories tĩnh -->
<c:set var="categories" value="${['Technology', 'Web Development', 'Design']}" />

<!-- Truyền danh sách relatedPosts tĩnh -->
<c:set var="relatedPosts" value="${[ 
    { 'blogId': 2, 'title': 'Related Blog Post 1', 'thumbnailUrl': 'img/img-02.jpg' }, 
    { 'blogId': 3, 'title': 'Related Blog Post 2', 'thumbnailUrl': 'img/img-05.jpg' }
]}" />
            ...
            <div class="col-lg-8 tm-post-col">
                <div class="tm-post-full">                    
                    <div class="mb-4">
                        ...
                        <p class="tm-mb-40">Last updated ${blog.updatedDate} posted by ${blog.authorName}</p>
                        <p>${blog.content}</p>
            ...
            <aside class="col-lg-4 tm-aside-col">
                <div class="tm-post-sidebar">
                    ...
                    <c:forEach var="relatedPost" items="${relatedPosts}">
                        <a href="blogDetail.jsp?blogId=${relatedPost.blogId}" class="d-block tm-mb-40">
                            <figure>
                                <img src="${relatedPost.thumbnailUrl}" alt="Image" class="mb-3 img-fluid">
